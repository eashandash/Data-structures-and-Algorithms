    ...
    int main(void)
   {
    int ch;
     do
        ...
        printf("\nCreate 1st expression( in standard form -DECENDING ORDER OF POWER )\n");
        my_create_poly(&poly1);
        printf("\nStored the 1st expression (in standard form -DECENDING ORDER OF POWER )");
        my_show_poly(poly1);

        printf("\nCreate 2nd expression ( in standard form -DECENDING ORDER OF POWER )\n");
        my_create_poly(&poly2);
        printf("\nStored the 2nd expression( in standard form -DECENDING ORDER OF POWER )");
        my_show_poly(poly2);
